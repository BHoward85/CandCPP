...
/**
 * @brief Opens .ushrc file.
 *
 * @parameter char * fileName - the name of the file
 * @parameter int * mode - if the file alread is there = 1, else 0 if the file wasn't there
 *
 * @return FILE * - Representing the open file
 */

FILE * openRCFile(char * fileName, int * mode);

FILE * readHISTFile(char * fileName, int * mode);

FILE * writeHISTFile(char * fileName, int * mode);
